...
/**
 * Tests for /dashboard/manager page — S3 (Boucle 2 F4): en mode real le
 * dashboard passe par le proxy /api/rt et l'agence vient des claims vérifiés.
 * @module app/dashboard/manager/page.test
 */
...
describe("S3: /dashboard/manager — proxy authentifié + agence des claims", () => {
  beforeEach(() => {
    cookieStore.clear();
  ...
  it("S3: mode real → apiBase /api/rt + agencyId des claims vérifiés", async () => {
