 ...
 * Critères 1, 2, 4 de la story CONTRACT-009.
 *
 ...
 *
 * Note : critère 3 (déterminisme generate 2×) déplacé vers bundle-determinism.test.ts
 * car il spawne `pnpm generate` — exclu du gate couverture rapide (T8 contention CI).
...
// Suite 3 (déterminisme generate 2×) → voir bundle-determinism.test.ts (runtime uniquement)
